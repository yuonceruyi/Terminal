...
namespace YuanTu.Devices.CardReader
{
    ...
    /// TypeA类型射频读卡
    /// </summary>
    public interface IRFCpuCardReader: IDevice
    {
        RFCpuType CpuType { get; set; }
        /// <summary>
        ///     获取卡在设备上的位置
        /// </summary>
        /// <returns></returns>
    ...
    public class A6RFCpuCardReader : IRFCpuCardReader
    {
        public virtual string DeviceName => "ACT_A6";
        public virtual string DeviceId => DeviceName + "_RFIC";
        private int _baud;
        ...
        public A6RFCpuCardReader(IConfigurationManager configurationManager)
        {
