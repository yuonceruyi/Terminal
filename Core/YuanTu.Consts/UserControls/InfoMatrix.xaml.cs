...
namespace YuanTu.Consts.UserControls
{
    ...
    public partial class InfoMatrix : UserControl, INotifyPropertyChanged
    {
        public InfoMatrix()
        {
            ...
            {
                Resources.Source = new Uri("pack://application:,,,/Terminal;component/Theme/default.xaml");
            }

            PropertyChanged += OnPropertyChanged;
            NextPageCommand = new DelegateCommand(() => Page++, () => Page + 1 < PageCount);
            PrevPageCommand = new DelegateCommand(() => Page--, () => Page > 0);
            ButtonPrev.Command = PrevPageCommand;
            ButtonNext.Command = NextPageCommand;
        }

        private DelegateCommand NextPageCommand { get; }
        private DelegateCommand PrevPageCommand { get; }
        ...
        private void OnPropertyChanged(object sender, PropertyChangedEventArgs e)
        {
            ...
            ButtonNext.Visibility = NextPageCommand.CanExecute() ? Visibility.Visible : Visibility.Hidden;
            ButtonPrev.Visibility = PrevPageCommand.CanExecute() ? Visibility.Visible : Visibility.Hidden;
