    ...
    public class ICPOS : IICPOS
    {
        ...
        public virtual bool SecondHalf(Output output)
        {
            try
            {
                ...
                var success = 交易结束(eaRes.IsSuccess);
        ...
        protected virtual Result<string> GetIssuerKey()
        {
            ...
            if (string.CompareOrdinal(DateTimeCore.Today.ToString("yyMM"), year + month) > 0)
        ...
        protected virtual void 处理限制()
        {
            ...
            var today = Convert.ToInt32(DateTimeCore.Today.ToString("yyMMdd"));
