...
namespace YuanTu.ISO8583.广州
{
    public class Loader : ILoader
    {
        ...
        public IManager Initialize(IConfig config)
        {
            ...
            builder.RegisterType<IO.Encoder>().PropertiesAutowired().As<IEncoder>();
        ...
        private BuildConfig BuildConfig()
        {
            var fields = new List<Field>
            {
                ...
                new Field {Id = 2, Name = "PAN", Length = 19, Format = Format.ASCII, VarType = VarType.LLVar},
                new Field {Id = 3, Name = "ProcCode", Length = 6, Format = Format.ASCII, VarType = VarType.Fixed},
                new Field {Id = 4, Name = "TranAmt", Length = 12, Format = Format.ASCII, VarType = VarType.Fixed},
                new Field {Id = 7, Name = "TranDtTm", Length = 10, Format = Format.ASCII, VarType = VarType.Fixed},
                new Field {Id = 11, Name = "AcqSsn", Length = 6, Format = Format.ASCII, VarType = VarType.Fixed},
                new Field {Id = 12, Name = "LTime", Length = 6, Format = Format.ASCII, VarType = VarType.Fixed},
                new Field {Id = 13, Name = "LDate", Length = 4, Format = Format.ASCII, VarType = VarType.Fixed},
                ...
                new Field {Id = 22, Name = "EntrMode", Length = 3, Format = Format.ASCII, VarType = VarType.Fixed},
                new Field {Id = 23, Name = "CardSNum", Length = 3, Format = Format.ASCII, VarType = VarType.Fixed},
                new Field {Id = 25, Name = "CondMode", Length = 2, Format = Format.ASCII, VarType = VarType.Fixed},
                ...
                new Field {Id = 35, Name = "Trck2Dat", Length = 37, Format = Format.ASCII, VarType = VarType.LLVar},
                new Field {Id = 36, Name = "Trck3Dat", Length = 104, Format = Format.ASCII, VarType = VarType.LLLVar},
                ...
                new Field {Id = 60, Name = "ReveCode", Length = 13, Format = Format.ASCII, VarType = VarType.LLLVar},
                new Field {Id = 61, Name = "IdentNum", Length = 80, Format = Format.ASCII, VarType = VarType.LLLVar},
            ...
            return new BuildConfig
            {
                ...
                BitmapLength = 128,
                MACFieldId = 128,
                VarFormat = VarFormat.ASCII,
                LengthFormat = VarFormat.ASCII,
                MTIFormat = VarFormat.ASCII,
                OmitHead = true,
                OmitTPDU = true,
