...
namespace YuanTu.ShenZhen.BaoAnShiYanHospital
{
    public class Startup : Default.Startup
    {
        ...
        {
            YuanTu.Core.Gateway.DataHandler.ErrorMsgDict["积极拒绝"] = "前置服务异常，请联系计管办处理！";
            //YuanTu.Core.Gateway.DataHandler.ErrorMsgDict["无法连接的主机"] = "本机网络异常，请联系计管办处理！";  //林主任对网络异常这样显示有意见
            YuanTu.Core.Gateway.DataHandler.ErrorMsgDict["无法连接的主机"] = "无法连接到主机，请联系计管办处理！";
            YuanTu.Core.Gateway.DataHandler.ErrorMsgDict["没有正确答复或连接的主机没有反应"] = "前置网络服务异常，请联系计管办处理！";
            var file = Path.Combine("CurrentResource", FrameworkConst.HospitalId + ".xml");
            return new[] { file };
        }
        ...
        {
            base.AfterStartup();
            FrameworkConst.HospitalName = "深圳市宝安区石岩人民医院";
            ConfigBaoAnShiYanHospital.Init();
        }
        public override List<Uri> GetResourceDictionaryUris()
        {
            var uris = base.GetResourceDictionaryUris();
            uris.Add(new Uri("pack://application:,,,/YuanTu.ShenZhen.BaoAnShiYanHospital;component/Theme/default.xaml"));
            return uris;
        }
        ...
        public override bool RegisterTypes(ViewCollection children)
        {
            ...
            children.Add(A.QH.Record, "选择预约记录", typeof(Default.Component.TakeNum.Views.ApptRecordView), A.QH.TakeNum);
            children.Add(A.QH.TakeNum, "确认取号信息", typeof(Default.Component.TakeNum.Views.TakeNumView), A.QH.Confirm);
            children.Add(A.QH.Confirm, "确认取号支付", typeof(Default.Component.Views.ConfirmView), A.QH.Print);
            ...
            children.Add(A.YP.Medicine, "药品信息列表", typeof(Default.Component.InfoQuery.Views.MedicineItemsView), A.Home);
            ...
            children.Add(A.XM.ChargeItems, "诊疗项列表", typeof(Default.Component.InfoQuery.Views.ChargeItemsView), A.Home);
            ...
            children.Add(A.JYJL.DiagReport, "查询检验报告", typeof(Component.InfoQuery.Views.DiagReportView),  A.Home);
            ...
            children.Add(A.CZJL.ReChargeRecord, "预交金记录信息", typeof(Default.Component.InfoQuery.Views.RechargeRecordView), A.Home);
            ...
            children.Add(A.ZY.InPatientNo, "住院患者信息", typeof(Default.Component.Auth.Views.InPatientNoView), A.ZY.InPatientInfo);
            ...
            children.Add(A.ZYYRQD.DailyDetail, "住院一日清单", typeof(Default.Component.InfoQuery.Views.InDailyDetailView), A.Home);
            ...
            //children.Add(A.JFBD.PayCostRecord, "已缴费信息", typeof(YuanTu.ShenZhen.BaoAnShiYanHospital.Component.InfoQuery.Views.PayCostRecordView), A.Home);
