...
namespace YuanTu.ShenZhen.BaoAnChineseMedicineHospital.Component.Tools.ViewModels
{
    public class PosViewModel : Default.Component.Tools.ViewModels.PosViewModel
    {
        ...
        {
            PosConfig = ConfigBaoAnChineseMedicineHospital.PosConfig;
        ...
        protected override bool InitializePos()
        {
            ...
            Manager = new Loader().Initialize(PosConfig);
        ...
        protected override bool SureGetCard()
        {
            ...
            while (local == _seed)
            {
                ...
                Thread.Sleep(3000);   //立马去读的话会出现读取失败的情况
