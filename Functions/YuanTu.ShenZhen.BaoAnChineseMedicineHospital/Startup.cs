...
using YuanTu.Default.Clinic.Component.InfoQuery.Views;
using YuanTu.Default.Clinic.Component.ZYRecharge.Views;
...
namespace YuanTu.ShenZhen.BaoAnChineseMedicineHospital
{
    public class Startup : Default.Startup
    {
        ...
        {
            base.AfterStartup();
            FrameworkConst.HospitalName = "深圳市宝安中医院（集团）";
            ConfigBaoAnChineseMedicineHospital.Init();
        }
        ...
        public override bool RegisterTypes(ViewCollection children)
        {
            ...
            children.Add(A.CK.QrCode, "个人信息", typeof(Component.Auth.Views.QrCodeView), A.CK.Info);
            ...
            children.Add(A.QH.Query, "输入取号订单号",typeof(Component.TakeNum.Views.QueryView), A.QH.TakeNum);
