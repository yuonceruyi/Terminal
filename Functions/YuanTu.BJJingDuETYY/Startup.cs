...
using BJAuthVi = YuanTu.BJJingDuETYY.Component.Auth.Views;
using BJQueryVi = YuanTu.BJJingDuETYY.Component.InfoQuery.Views;
using BJBiometricVi = YuanTu.BJJingDuETYY.Component.Biometric.Views;
using BJToolsVi = YuanTu.BJJingDuETYY.Component.Tools.Views;
...
using YuanTu.BJJingDuETYY.Component.InfoQuery.Views;
using YuanTu.BJJingDuETYY.Current.Services;
using YuanTu.BJJingDuETYY.Current.Models;
using Microsoft.Practices.Unity;
using DefClinicVi = YuanTu.Default.Clinic.Component;
using YuanTu.BJJingDuETYY.Clinic.Component.SignIn;
using Microsoft.Practices.ServiceLocation;
using YuanTu.Consts.Services;
using YuanTu.Consts.Enums;
using YuanTu.BJJingDuETYY.Component.Auth.Views;
...
namespace YuanTu.BJJingDuETYY
{
    public class Startup : DefaultStartup
    {
        ...
        {
            FrameworkConst.HospitalName = "北京京都儿童医院";
            BJArea.ConfigBJ.HighPwd = "870113";
            ...
            BJArea.ConfigBJ.ScheduleVersion = "1";
        ...
        public override bool RegisterTypes(ViewCollection children)
        {
            ...
            children.Add(A.Third.SiPay, null, "投币/刷卡/扫码", typeof(BJToolsVi.SiPayView));
            ...
            children.Add(AInner.CK.BarScan, "个人信息", typeof(BarScanView), A.CK.Info);
            children.Add(A.CK.Card, "个人信息", typeof(DefAuthVi.CardView), A.CK.Info);
            children.Add(A.CK.FaceRec, "个人信息", typeof(BJAuthVi.FaceRecView), A.CK.Info);
            children.Add(A.CK.IDCard, "个人信息", typeof(BJAuthVi.IDCardView), A.CK.Info);
            children.Add(A.CK.InputIDCard, "个人信息", typeof(BJAuthVi.InputIDView), A.CK.Info);
            children.Add(A.CK.HICard, "个人信息", typeof(BJAuthVi.SiCardView), A.CK.Info);
            children.Add(A.CK.QrCode, "个人信息", typeof(DefAuthVi.QrCodeView), A.CK.Info);
            children.Add(A.CK.Info, "个人信息", typeof(BJAuthVi.PatientInfoView), A.Home);
            children.Add(A.CK.InfoEx, "个人信息", typeof(BJAuthVi.PatientInfoExView), A.Home);
            ...
            children.Add(A.QH.TakeNum, "确认取号信息", typeof(BJJingDuETYY.Component.TakeNum.Views.TakeNumView), A.QH.Confirm);
            ...
            children.Add(AInner.JYJL.Print, "检验结果", typeof(PrintView), A.Home);
            ...
            children.Add(A.ZYYRQD.DailyDetail, "住院一日清单", typeof(BJQueryVi.InDailyDetailView), A.Home);
            ...
            children.Add(A.Bio.Choice, "选择录入信息", typeof(BJBiometricVi.ChoiceView), A.Bio.FaceRec);
            children.Add(A.Bio.FaceRec, "面部信息录入", typeof(BJBiometricVi.FaceRecView), A.Home);
            children.Add(A.Bio.FingerPrint, "指纹信息录入", typeof(BJBiometricVi.FingerPrintView), A.Home);
        ...
        public bool RegisterClinicTypes(ViewCollection children)
        {
            ...
            children.Add(A.Third.PosUnion, null, "刷卡", typeof(BJToolsVi.PosView));
            ...
            children.Add(A.CK.Card, "个人信息", typeof(BJAuthVi.CardView), A.CK.Info);
            children.Add(A.CK.IDCard, "个人信息", typeof(BJAuthVi.IDCardView), A.CK.Info);
            children.Add(A.CK.HICard, "个人信息", typeof(BJAuthVi.SiCardView), A.CK.Info);
            children.Add(A.CK.Info, "个人信息", typeof(BJAuthVi.PatientInfoView), A.Home);
            children.Add(A.CK.InfoEx, "个人信息", typeof(BJAuthVi.PatientInfoExView), A.Home);
