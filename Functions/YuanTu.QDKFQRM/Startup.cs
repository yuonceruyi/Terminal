...
using YuanTu.QDKFQRM.Component.ZYRecharge.Views;

namespace YuanTu.QDKFQRM
{
    public class Startup : DefaultStartup
    {
        ...
        {
            FrameworkConst.HospitalName = "青岛开发区第一人民医院";
            QDArea.ConfigQD.HighPwd = "347756";
        ...
        public override bool RegisterTypes(ViewCollection children)
        {
            ...
            children.Add(A.ZYCZ.PayerName, "输入交款人姓名", typeof(PayerNameView), A.ZYCZ.RechargeWay);
            ...
            children.Add(A.ZYYJ.Date, "选择查询日期", typeof(DefQueryVi.DateTimeView), A.ZYYJ.InPrePayRecord);
            children.Add(A.ZYYJ.InPrePayRecord, "住院押金记录", typeof(QDQueryVi.InPrePayRecordView), A.Home);

            children.Context = A.InBedInfoQuery_Context;
            children.Add(A.CW.InBedInfo, "床位信息查询", typeof(QDQueryVi.InBedInfoView), A.Home);
            return true;
        }
    }
}