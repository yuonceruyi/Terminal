...
namespace YuanTu.TaiZhouCentralHospital.HealthInsurance
{
    public class UnSafeMethods
    {
        ...
        //private const string DllPathSiInterface = "External\\TaiZhouSiDll\\BargaingApplyV3_01044.dll";
        private const string DllPathSiInterface = "BargaingApplyV3_01044.dll";
        ...
        [DllImport(DllPathSiInterface, EntryPoint = "f_UserBargaingApply", CharSet = CharSet.Ansi,
            CallingConvention = CallingConvention.StdCall)]
        public static extern int f_UserBargaingApply(int Code, double No, string Data, StringBuilder retMsg,
            string Data2);
