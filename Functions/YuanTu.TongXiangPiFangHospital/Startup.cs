...
namespace YuanTu.TongXiangPiFangHospital
{
    public class Startup : TongXiangHospitals.Startup
    {
        ...
        {
            base.AfterStartup();
            FrameworkConst.HospitalName = "桐乡市皮肤病防治院\n上海市皮肤病医院桐乡分院";
        }
        ...
        {
            var file = Path.Combine(FrameworkConst.RootDirectory, "CurrentResource", FrameworkConst.HospitalId,
                "TongXiangConfig.xml");
            return new[] {file};
        }
    }
