...
namespace YuanTu.NanYangFirstPeopleHospital
{
    public class Startup: DefaultStartup
    {
        ...
        {
            FrameworkConst.HospitalName = "南阳市第一人民医院";
            CashInputBox.AcceptBills = CashInputBox.Bills.All;
        }
        ...
        public override bool RegisterTypes(ViewCollection children)
        {
            ...
            children.Add(A.ZY.Card, "住院患者信息", typeof(InCardView), A.ZY.InPatientInfo);
            //children.Add(AInner.ZY.InPatientPhone, "输入手机号", typeof(InputPhoneView), A.ZY.InPatientInfo);
