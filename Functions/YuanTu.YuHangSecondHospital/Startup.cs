...
using YuanTu.YuHangSecondHospital.Component.TakeNum.Views;
...
using SiCardView = YuanTu.YuHangSecondHospital.Component.Auth.Views.SiCardView;
...
namespace YuanTu.YuHangSecondHospital
{
    public class Startup : DefaultStartup
    {
        ...
        {
            return new[] {"CurrentResource\\余杭二院.xml"};
        }

        public override void AfterStartup()
        {
            FrameworkConst.HospitalName = "余杭区第二人民医院";
