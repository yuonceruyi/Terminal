...
namespace YuanTu.ShenZhen.PekingUniversityHospital.Component.InfoQuery.ViewModels
{
        ...
        protected override void PayCostQuery()
        {
            ...
            DoCommand(lp =>
            {
                ...
                PayCostRecordModel.Req获取已结算记录 = new req获取已结算记录
                {
                    ...
                    extend = PatientModel.Res病人信息查询?.data[PatientModel.PatientInfoIndex].name
                };
