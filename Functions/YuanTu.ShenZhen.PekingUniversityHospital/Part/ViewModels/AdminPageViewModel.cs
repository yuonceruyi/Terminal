...
namespace YuanTu.ShenZhen.PekingUniversityHospital.Part.ViewModels
{
    public class AdminPageViewModel : YuanTu.Default.Part.ViewModels.AdminPageViewModel
    {
        protected override bool OnValidatePassword(string pwd)
        {
            ...
            switch (pwd)
            {
                case ConfigPekingUniversityHospital.ExitPass:
                    AuthTypes.Add(AdminType.退出系统);
                    break;
                case ConfigPekingUniversityHospital.ClearCashboxPass:
