...
namespace YuanTu.ShenZhen.PekingUniversityHospital
{
    public class Startup : Default.Startup
    {
        ...
        {
            base.AfterStartup();
            FrameworkConst.HospitalName = "北京大学深圳医院";
            ConfigPekingUniversityHospital.Init();
        }
        ...
        public override bool RegisterTypes(ViewCollection children)
        {
            ...
            children.Add(A.CK.HICard, "个人信息", typeof(Default.Component.Auth.Views.SiCardView), InnerA.CK.HICardPassword);
            ...
            children.Add(A.XC.Schedule, "选择医生排班", typeof(Default.Component.Register.Views.ScheduleView), A.XC.Schedule);
            children.Add(A.XC.Time, "选择排班分时", typeof(Default.Component.Register.Views.SourceView), A.XC.Confirm);
            ...
            children.Add(A.QH.Query, "输入取号订单号",typeof(Default.Component.TakeNum.Views.QueryView), A.QH.TakeNum);
