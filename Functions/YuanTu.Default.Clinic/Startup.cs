...
using BillRecordView = YuanTu.Default.Clinic.Component.BillPay.Views.BillRecordView;
...
using InDailyDetailView = YuanTu.Default.Clinic.Component.InfoQuery.Views.InDailyDetailView;
...
namespace YuanTu.Default.Clinic
{
    public class Startup : YuanTu.Core.FrameworkBase.DefaultStartup
    {
        ...
        public override bool RegisterTypes(ViewCollection children)
        {
            ...
            children.Add(A.AdminPart, null, "后台", typeof(Part.Views.AdminPageView));
            ...
            children.Add(A.CK.Choice, "个人信息", typeof(Component.Auth.Views.ChoiceView), A.CK.Card);
