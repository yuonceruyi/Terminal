...
using YuanTu.XiaoShanArea.CYHIS;
using YuanTu.XiaoShanHealthStation.Component.Register.Views;
using BillRecordView = YuanTu.XiaoShanHealthStation.Component.BillPay.Views.BillRecordView;
using RechargeMethodView = YuanTu.XiaoShanHealthStation.Component.Recharge.Views.RechargeMethodView;
...
namespace YuanTu.XiaoShanHealthStation
{
    public class Startup:YuanTu.Default.Startup
    {
        ...
        {
            return new[] { "CurrentResource\\萧山计生站.json", "CurrentResource\\萧山计生站.xml" };
        }
        public override void AfterStartup()
        {
            base.AfterStartup();
            FrameworkConst.HospitalName = "萧山区公共卫生服务中心";
        ...
        public override bool RegisterTypes(ViewCollection children)
        {
            ...
            children.Add(A.XC.Wether, "选择挂号类别", typeof(RegTypesView), InnerA.XC.AmPm);
            children.Add(InnerA.XC.AmPm,"选择挂号时段",typeof(AmPmView),A.XC.Dept);
            ...
            children.Add(A.YY.Wether, "选择预约类别", typeof(RegTypesView), InnerA.YY.AmPm);
            children.Add(InnerA.YY.AmPm,"选择预约时段",typeof(AmPmView),A.YY.Dept);
