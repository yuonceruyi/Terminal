...
namespace YuanTu.ZheJiangZhongLiuHospital.ICBC
{
	...
	[XmlType("TransInfo")]
	public class Req开户 : IReq
	{
		public string ClassName => "开户";

		public string TransCode { get; set; } = "10100";
		...
		public string Policemark { get; set; }
		public string Cardkind { get; set; }
		public string Cardid { get; set; }
		public string SignBankCardFlag { get; set; }
		public string BankCardNo { get; set; }
		public string OperId { get; set; }
		public string DeviceInfo { get; set; }
		public string TradeSerial { get; set; }
