...
namespace YuanTu.FuYangRMYY
{
    public class Startup: DefaultStartup
    {
        ...
        public override bool RegisterTypes(ViewCollection children)
        {
            ...
            children.Add(A.XC.Dept, "选择挂号科室", typeof(DeptsView), A.XC.Schedule);
            ...
            children.Add(A.YY.Date, "选择预约日期", typeof(RegDateView), A.YY.Dept);
            ...
            children.Add(A.JYJL.DiagReport, "检验报告信息", typeof(YuanTu.FuYangRMYY.Component.InfoQuery.Views.DiagReportView), A.Home);
            ...
            children.Add(A.CZJL.ReChargeRecord, "预交金记录信息", typeof(YuanTu.FuYangRMYY.Component.InfoQuery.Views.RechargeRecordView), A.Home);
            ...
            children.Add(A.ZY.HICard, "个人信息", typeof(Component.Auth.Views.InSiCardView), A.ZY.InPatientInfo);
            ...
            children.Add(A.SignIn.RegisterInfoSelect, "排队叫号签到", typeof(YuanTu.Default.Component.SignIn.Views.QueueSelectView), A.Home);
        ...
        protected virtual bool RegisterClinicTypes(ViewCollection children)
        {
            ...
            children.Context = A.YuYue_Context;
            children.Add(A.YY.Date, "选择预约日期", typeof(Default.Clinic.Component.Register.Views.RegDateView), A.YY.Dept);
            ...
            children.Add(A.QueryChoice, null, "查询选择", typeof(FuYangRMYY.Component.InfoQuery.Views.QueryChoiceView));
            children.Context = A.ChongZhi_Context;
            ...
            children.Add(A.ZY.Card, "个人信息", typeof(Component.Auth.Views.InCardView), A.ZY.InPatientInfo);
        ...
        {
            return new[] { "CurrentResource\\阜阳人民医院.xml" };
        }

        public override void AfterStartup()
        {
            FrameworkConst.HospitalName = "阜阳市人民医院\n颍东农商银行";
