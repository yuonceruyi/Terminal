...
using YuanTu.YiWuBeiYuan.Common;
using YuanTu.YiWuBeiYuan.Component.BillPay.Models;
using YuanTu.YiWuBeiYuan.Models;
using CardModel = YuanTu.YiWuBeiYuan.Models.CardModel;

namespace YuanTu.YiWuBeiYuan.Component.BillPay.ViewModels
{
    public class BillRecordViewModel: YuanTu.Default.Component.BillPay.ViewModels.BillRecordViewModel
    {
        ...
        protected virtual void PerPayWithSi(LoadingProcesser lp)
        {
            ...
            PaymentModel.Self = (个人现金支付 - 民政补助支付 - 大病救助支付) ;
            PaymentModel.Insurance = (合计报销金额 + 民政补助支付 + 大病救助支付);
            PaymentModel.Total = 费用总额;
