...
using CardView = YuanTu.YiWuBeiYuan.Component.Auth.Views.CardView;
using ChoiceView = YuanTu.YiWuBeiYuan.Component.Views.ChoiceView;
using PatientInfoExView = YuanTu.YiWuBeiYuan.Component.Auth.Views.PatientInfoExView;
...
namespace YuanTu.YiWuBeiYuan
{
    public class Startup : YuanTu.Default.Startup
    {
        ...
        public override string[] UseConfigPath()
        {
            ...
            return new[] { "CurrentResource\\义乌北苑.json", "CurrentResource\\义乌北苑.xml" };
        }

        public override List<Uri> GetResourceDictionaryUris()
        {
            var uris = base.GetResourceDictionaryUris();
            uris.Add(new Uri("pack://application:,,,/YuanTu.YiWuBeiYuan;component/Theme/default.xaml"));
            return uris;
        }

        public override void AfterStartup()
        {
            FrameworkConst.HospitalName = "北苑街道社区卫生服务中心";
