...
namespace YuanTu.BJArea.QueueSignIn
{
    public class SignInService
    {
        private static string deviceSecret;
        private static string token;
        private static DataHandlerBJ dataHandler;
        ...
        public  static Result Init()
        {
            ...
            dataHandler = new DataHandlerBJ { Uri = new Uri(config.GetValue("SignInUrl")) };
    ...
    {
        public static Result<ResGetSecret> Query(this DataHandlerBJ dataHandler, ReqGetSecret req)
        {
            return dataHandler.Query<ResGetSecret, ReqGetSecret>(req);
        }

        public static Result<ResGetAccessToken> Query(this DataHandlerBJ dataHandler, ReqGetAccessToken req)
        {
            return dataHandler.Query<ResGetAccessToken, ReqGetAccessToken>(req);
        }
        public static Result<ResQueryQueueByDevice> Query(this DataHandlerBJ dataHandler, ReqQueryQueueByDevice req)
        {
            return dataHandler.Query<ResQueryQueueByDevice, ReqQueryQueueByDevice>(req);
        }
        public static Result<ResConfirmTakeNo> Query(this DataHandlerBJ dataHandler, ReqConfirmTakeNo req)
        {
