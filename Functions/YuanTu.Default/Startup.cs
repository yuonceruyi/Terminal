...
namespace YuanTu.Default
{
    public class Startup : DefaultStartup
    {
        ...
        public override bool RegisterTypes(ViewCollection children)
        {
            ...
            children.Add(A.JFJL.Date, "选择查询日期", typeof(Component.InfoQuery.Views.DateTimeView), A.JFJL.PayCostRecord);
            ...
            children.Add(A.YP.QueryDisplay, "药品展示搜索", typeof(QueryDisplayView), A.Home);
            ...
            children.Add(A.JYJL.Date, "选择查询日期", typeof(Component.InfoQuery.Views.DateTimeView), A.JYJL.DiagReport);
            children.Add(A.JYJL.DiagReport, "检验报告信息", typeof(DiagReportView), A.Home);

            children.Context = A.PacsReportQuery;
            children.Add(A.YXBG.Date, "选择查询日期", typeof(Component.InfoQuery.Views.DateTimeView), A.YXBG.PacsReport);
            children.Add(A.YXBG.PacsReport, "影像报告信息", typeof(PacsReportView), A.Home);

            children.Context = A.ReChargeQuery;
            children.Add(A.CZJL.Date, "选择查询日期", typeof(Component.InfoQuery.Views.DateTimeView), A.CZJL.ReChargeRecord);
            ...
            children.Context = A.PayCostQuery;
            children.Add(A.JFBD.Date, "选择查询日期", typeof(Component.PrintAgain.Views.DateTimeView), A.JFBD.PayCostRecord);
            children.Add(A.JFBD.PayCostRecord, "已缴费信息", typeof(Component.PrintAgain.Views.PayCostRecordView), A.Home);
            children.Add(A.JFBD.Print, "补打完成", typeof(PrintView), A.Home);

            children.Context = A.RealAuth_Context;
            children.Add(A.SMRZ.Card, "插入就诊卡", typeof(Component.RealAuth.Views.CardView), A.SMRZ.PatientInfo);
            children.Add(A.SMRZ.PatientInfo, "密码校验", typeof(Component.RealAuth.Views.PatientInfoView), A.SMRZ.IDCard);
            children.Add(A.SMRZ.IDCard, "刷身份证", typeof(Component.RealAuth.Views.IDCardView), A.Home);



            children.Context = A.QueneSelect_Context;
            children.Add(A.SignIn.RegisterInfoSelect, "排队叫号签到", typeof(Component.SignIn.Views.QueueSelectView), A.Home);
            return true;
        }
