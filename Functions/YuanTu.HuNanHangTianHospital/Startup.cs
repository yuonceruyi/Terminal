...
namespace YuanTu.HuNanHangTianHospital
{
    public class Startup:YuanTu.Core.FrameworkBase.DefaultStartup
    {
        ...
        public override bool RegisterTypes(ViewCollection children)
        {
            ...
            children.Add(A.Third.PosUnion, null, "投币/刷卡/扫码", typeof(YuanTu.HuNanHangTianHospital.Component.Tools.Views.PosView));
            ...
            children.Add(Guid.NewGuid().ToString(), "银联支付", null, A.JD.Print);
            ...
            children.Add(A.XC.Dept, "选择挂号科室", typeof(DeptsView), A.XC.Wether);
            children.Add(A.XC.Wether, "选择挂号类别", typeof(RegTypesView), A.XC.Doctor);
            ...
            children.Add(Guid.NewGuid().ToString(), "银联支付", null, A.XC.Print);
            ...
            children.Add(A.YY.Dept, "选择预约科室", typeof(DeptsView), A.YY.Wether);
            children.Add(A.YY.Wether, "选择预约类别", typeof(RegTypesView), A.YY.Doctor);
            ...
            children.Add(Guid.NewGuid().ToString(), "银联支付", null, A.CZ.Print);
           ...
           // children.Add(A.JYJL.Date, "选择查询日期", typeof(DateTimeView), A.JYJL.DiagReport);
            ...
            children.Add(Guid.NewGuid().ToString(), "银联支付", null, A.ZYCZ.Print);
        ...
        {
            FrameworkConst.HospitalName = "湖南航天医院";
        }
