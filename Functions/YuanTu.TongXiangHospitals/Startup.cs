...
namespace YuanTu.TongXiangHospitals
{
    public class Startup : DefaultStartup
    {
        ...
        public static bool TestRefund { get; set; } = false;

        public override void AfterStartup()
        {
            var config = ServiceLocator.Current.GetInstance<IConfigurationManager>();
            var name = config.GetValue("HospitalName")?.Replace('|', '\n');
        ...
        public override bool RegisterTypes(ViewCollection children)
        {
            ...
            //children.Add(AInner.XC.PayChoice, "选择支付方式", typeof(Component.Views.PayChoiceView), A.XC.Confirm);
            ...
            //children.Add(AInner.QH.PayChoice, "选择支付方式", typeof(Component.Views.PayChoiceView), A.QH.Confirm);
            ...
            //children.Add(AInner.JF.PayChoice, "选择支付方式", typeof(Component.Views.PayChoiceView), A.JF.Confirm);
