...
using YuanTu.QDQLYY.Component.InfoQuery.Views;
using YuanTu.QDQLYY.Current.Services;
using YuanTu.QDQLYY.Current.Models;
using Microsoft.Practices.Unity;
using DefClinicVi = YuanTu.Default.Clinic.Component;
using YuanTu.QDQLYY.Clinic.Component.SignIn;
...
namespace YuanTu.QDQLYY
{
    public class Startup : DefaultStartup
    {
        ...
        {
            return new[] { @"CurrentResource\284\config.xml" };
        }
        public override void AfterStartup()
        {
            FrameworkConst.HospitalName = "山东大学齐鲁医院（青岛）";
        ...
        public override bool RegisterTypes(ViewCollection children)
        {
            ...
            children.Add(A.CK.HICard, "个人信息", typeof(QDAuthVi.SiCardView), A.CK.Info);
            ...
            children.Add(A.XC.Wether, "选择挂号类别", typeof(RegTypesView), A.XC.ParentDept);
            ...
            children.Add(A.YY.Wether, "选择预约类别", typeof(RegTypesView), A.YY.ParentDept);
            ...
            */
            ...
            children.Add(A.ZY.Choice, "个人信息", typeof(DefAuthVi.ChoiceView), A.ZY.InPatientNo);
            children.Add(A.ZY.IDCard, "个人信息", typeof(DefAuthVi.InIDCardView), A.ZY.InPatientInfo);
            children.Add(A.ZY.HICard, "个人信息", typeof(YuanTu.QDQLYY.Component.Auth.Views.InSiCardView), A.ZY.InPatientInfo);
            children.Add(A.ZY.InPatientNo, "住院患者信息", typeof(DefAuthVi.InPatientNoView), A.ZY.InPatientInfo);
            children.Add(A.ZY.InPatientInfo, "住院患者信息", typeof(YuanTu.QDQLYY.Component.Auth.Views.InPatientInfoView), A.Home);

            children.Context = A.InDayDetailList_Context;
            children.Add(A.ZYYRQD.Date, "选择查询日期", typeof(DefQueryVi.DateTimeView), A.ZYYRQD.DailyDetail);
            ...
            children.Context = AInner.DeptInfo_Context;
            children.Add(AInner.KSXX.DeptList, "科室列表", typeof(DeptsInfoListView), AInner.KSXX.DeptInfo);
            children.Add(AInner.KSXX.DeptInfo, "科室信息", typeof(DeptsInfoView), AInner.KSXX.DocList);
            children.Add(AInner.KSXX.DocList, "医生列表", typeof(DocsInfoListView), AInner.KSXX.DocInfo);
            children.Add(AInner.KSXX.DocInfo, "医生信息", typeof(DocsInfoView), A.Home);

            children.Context = AInner.CYQD_Context;
            children.Add(AInner.CYQD.FeeList, "清单打印", typeof(InAllDetailPView), A.Home);
        ...
        public bool RegisterClinicTypes(ViewCollection children)
        {
            ...
            /*
            children.Context = A.XianChang_Context;
            children.Add(A.XC.Wether, "选择挂号类别", typeof(DefClinicVi.Register.Views.RegTypesView), A.XC.ParentDept);
            children.Add(A.XC.ParentDept, "选择科室分类", typeof(DefClinicVi.Register.Views.ParentDeptsView), A.XC.Dept);
            children.Add(A.XC.Dept, "选择挂号科室", typeof(DefClinicVi.Register.Views.DeptsView), A.XC.Doctor);
            ...
            children.Add(A.YY.Wether, "选择预约类别", typeof(DefClinicVi.Register.Views.RegTypesView), A.YY.ParentDept);
            children.Add(A.YY.ParentDept, "选择科室分类", typeof(DefClinicVi.Register.Views.ParentDeptsView), A.YY.Dept);
            children.Add(A.YY.Dept, "选择预约科室", typeof(DefClinicVi.Register.Views.DeptsView), A.YY.Doctor);
            ...
            */
            ...
            children.Add(A.ZY.Choice, "个人信息", typeof(DefAuthVi.ChoiceView), A.ZY.InPatientNo);
            children.Add(A.ZY.IDCard, "个人信息", typeof(DefAuthVi.InIDCardView), A.ZY.InPatientInfo);
            children.Add(A.ZY.HICard, "个人信息", typeof(DefAuthVi.InSiCardView), A.ZY.InPatientInfo);
            children.Add(A.ZY.InPatientNo, "住院患者信息", typeof(DefAuthVi.InPatientNoView), A.ZY.InPatientInfo);
