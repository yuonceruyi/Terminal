...
namespace YuanTu.NingXiaHospital.CardReader.DKA6
{
    public class DKA6CardReader : IRFCpuCardReader
    {
        ...
        public DKA6CardReader(IConfigurationManager configurationManager)
        {
            _configurationManager = configurationManager;
        }

        public virtual string DeviceName => "DKA6";
        ...
        public Result Connect()
        {
            ...
            _port = _configurationManager.GetValueInt("DKA6:Port");
            _baud = _configurationManager.GetValueInt("DKA6:Baud");
