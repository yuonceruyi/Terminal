...
using CardView = YuanTu.YiWuZYY.Component.Auth.Views.CardView;
using ChoiceView = YuanTu.YiWuZYY.Component.Views.ChoiceView;
using PatientInfoExView = YuanTu.YiWuZYY.Component.Auth.Views.PatientInfoExView;
using System.Drawing;

namespace YuanTu.YiWuZYY
{
    public class Startup : YuanTu.Default.Startup
    {
        ...
        public override string[] UseConfigPath()
        {
            ...
            return new[] { "CurrentResource\\义乌中医院.json", "CurrentResource\\义乌中医院.xml" };
        }

        public override List<Uri> GetResourceDictionaryUris()
        {
            var uris = base.GetResourceDictionaryUris();
            uris.Add(new Uri("pack://application:,,,/YuanTu.YiWuZYY;component/Theme/default.xaml"));
            return uris;
        }

        public override void AfterStartup()
        {
            FrameworkConst.HospitalName = "义乌中医院";
            PrintConfig.HeaderFont = new Font("微软雅黑", (CurrentStrategyType() == DeviceType.Clinic ? 10 : 14), FontStyle.Bold);
            ...
            YiWuZyyConnst.IsEnable = config.GetValueInt("OldCardSupport:IsEnable") == 1;
            YiWuZyyConnst.CanScreenInput = config.GetValueInt("OldCardSupport:CanScreenInput") == 1;
            YiWuZyyConnst.ScreenInputText = config.GetValue("OldCardSupport:ScreenInputText");
        }
