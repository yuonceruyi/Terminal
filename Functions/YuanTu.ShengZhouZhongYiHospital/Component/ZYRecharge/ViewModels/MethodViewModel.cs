...
namespace YuanTu.ShengZhouZhongYiHospital.Component.ZYRecharge.ViewModels
{
    public class MethodViewModel:YuanTu.Default.Component.ZYRecharge.ViewModels.MethodViewModel
    {
        ...
        protected override Queue<IPrintable> IpRechargePrintables(bool success)
        {
            ...
            sb.Append($"流水号：{IpRechargeModel.Res住院预缴金充值.data.receiptNo}\n");
            ...
            sb.Append($"请妥善保管好此凭条，出院结算时请出示此凭条交给结算处，谢谢合作！\n");
            sb.Append($"祝您早日康复！\n");
