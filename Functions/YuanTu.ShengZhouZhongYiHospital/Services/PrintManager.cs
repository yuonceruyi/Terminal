...
namespace YuanTu.ShengZhouZhongYiHospital.Services
{
    public class PrintManager : YuanTu.Core.Services.PrintService.PrintManager
    {
        public override Queue<IPrintable> NewQueue(string title)
        {
            ...
            { Text =FrameworkConst.HospitalName, StringFormat = PrintConfig.Center, Font = new Font("微软雅黑", 11, FontStyle.Bold) });
