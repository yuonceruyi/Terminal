...
namespace YuanTu.QDHD2ZY
{
    public class Startup : DefaultStartup
    {
        ...
        {
            var file = Path.Combine(FrameworkConst.RootDirectory, "CurrentResource", FrameworkConst.HospitalId, "Config.xml");            
            return new[] { file };
        }
        public override void AfterStartup()
        {
            FrameworkConst.HospitalName = "青岛市黄岛区第二中医医院";
            QDArea.ConfigQD.HighPwd = "88192826";
            SpecialDistrictsService.Init();
