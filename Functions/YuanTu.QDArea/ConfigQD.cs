...
using YuanTu.QDArea.Base;

namespace YuanTu.QDArea
{
    public class ConfigQD
    {
        ...
        public static void LoadDeptCompareAndInit()
        {
            ...
            if (SiPay=="1" || SiCard=="1")
            {
                QDArea.QingDaoSiPay.Function.Init();
            }
        }
        ...
        {           
            ...
            if (res?.success ?? false)
            {
                if (res != null)
                {
                    ...
                    QDArea.QingDaoSiPay.Common.SiSet.DeptCompare = DeptCompareDictionary;
                }
            }
        }
        public static string[] UseConfigPath()
        {
            return new[] { "ConfigQD.xml" };
        }
    }
}
