...
namespace YuanTu.ChongQingArea.Component.Register.ViewModels
{
    public class RegTypesViewModel : ViewModelBase
    {
        ...
        public override string Title => "请触摸下方卡片选择门诊类型";
        ...
        protected virtual void Confirm(Info i)
        {
            ...
            //if (RegTypesModel.SelectRegTypeName == RegType.便民门诊.ToString())
            //{
            //    Navigate(ChoiceModel.Business == Business.挂号 ? B.XC.SelectSi : A.YY.Confirm);
            //}
