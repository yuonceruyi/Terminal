...
namespace YuanTu.ShenZhen.BaoAnCenterHospital
{
    public class Startup : Default.Startup
    {
        ...
        {
            base.AfterStartup();
            FrameworkConst.HospitalName = "深圳市宝安区中心医院";
            ConfigBaoAnCenterHospital.Init();
        }
        ...
        public override bool RegisterTypes(ViewCollection children)
        {
            ...
            children.Add(InnerA.XC.DeptType, "选择挂号科室类型", typeof(Component.Register.Views.DeptTypeView), A.XC.Dept);
            ...
            children.Add(A.JYJL.DiagReport, "检验报告信息", typeof(Component.InfoQuery.Views.DiagReportView), A.Home);
            ...
            children.Add(A.ZY.HICard, "个人信息", typeof(Default.Component.Auth.Views.InSiCardView), InnerA.ZY.HICardPassword);//社保卡
            children.Add(InnerA.ZY.HICardPassword, "个人信息", typeof(Component.Auth.Views.SiCardPasswordView), A.ZY.InPatientInfo);  //社保卡密码
